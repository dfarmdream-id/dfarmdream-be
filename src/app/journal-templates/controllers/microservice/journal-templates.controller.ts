...
import { JournalTemplatesRepository, type Filter } from 'src/app/journal-templates/repositories';
import { JournalTemplatesService } from 'src/app/journal-templates/services';
import { PaginationQueryDto } from 'src/common/dtos/pagination-query.dto';
import { ResponseEntity } from 'src/common/entities/response.entity';
import { CreateJournalTemplatesDto, UpdateJournalTemplatesDto } from 'src/app/journal-templates/dtos';
...
export class JournalTemplatesMicroserviceController {
  ...
  public create(@Payload() createJournalTemplatesDto: CreateJournalTemplatesDto) {
    return from(this.journaltemplateService.create(createJournalTemplatesDto)).pipe(
  ...
  public update(
    ...
    return from(this.journaltemplateService.update(id, updateJournalTemplatesDto)).pipe(
      map(data => new ResponseEntity({
        data,
        message: 'success',
      })),
